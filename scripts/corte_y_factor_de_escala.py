...
def script():
    ...
    for img_file in img_files:
        ...
        if args.cut_area_shapefile is None:
            path_to_cut_file = os.path.join("/home/smbyc/cona3/Imagenes/Landsat/6.3.Area_Efectiva/", path_row)
        ...
        avg_image = "/home/smbyc/cona3/Imagenes/Landsat/Average_25_75/AV2575_C2_2000_2021_v1.tif"
